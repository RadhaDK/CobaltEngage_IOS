...
class CourtTimesViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UITableViewDelegate, UITableViewDataSource, ChartViewDelegate {
    ...
    func initController(){
        ...
        self.btnRequestTeeTime.setStyle(style: .outlined, type: .primary)
...
//Added by kiran V1.3 -- PROD0000069 -- Support to request events from club news on click of news
//PROD0000069 -- Start
extension CourtTimesViewController : RegisterEventVCDelegate
{
    
    //Added by kiran V1.4 --PROD0000069-- Club News - Added supoprt to upcoming event flyer image click.
    //PROD0000069 -- Start
    private func navigateToEventsScreen(selectedNews : RecentNewsCourt)
    {
    ...
    private func showEventScreenFromFlyer(event : UpComingCourt)
    {
        let eventDetails = EventNavDetails()
    ...
    private func showEventScreen(selectedNews : EventNavDetails)
    {
        ...
        case "0":
            ...
            else
            {
                ...
                registerVC.navigatedFrom = .tennis
...
//Added by kiran V1.4 --PROD0000069-- Club News - bring member to event details on click of news. Added support for composing Emails
//PROD0000069 -- Start
extension CourtTimesViewController : MFMailComposeViewControllerDelegate
{
