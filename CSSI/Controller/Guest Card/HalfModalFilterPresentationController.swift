//
//  HalfModalFilterPresentationController.swift
//  CSSI
//
//  Created by MACMINI13 on 02/07/18.
//  Copyright © 2018 yujdesigns. All rights reserved.
//

import UIKit

class HalfModalFilterPresentationController: UIPresentationController {
    ...
    //   var state: ModalScaleState = .adjustedOnce
...
protocol HalfModalPresentableFilter {
...
extension HalfModalPresentableFilter where Self: UIViewController {
    func maximizeToFullScreen() -> Void {
        if let presetation = navigationController?.presentationController as? HalfModalFilterPresentationController {
            presetation.changeScale(to: .adjustedOnce)
        }
    }
}

extension HalfModalPresentableFilter where Self: UINavigationController {
    func isHalfModalMaximized() -> Bool {
        if let presentationController = presentationController as? HalfModalFilterPresentationController {
