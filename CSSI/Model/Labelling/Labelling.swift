...
class Label: NSObject, Mappable  {
    ...
    var DINING_FCFS_DININGINFOTHREE : String?
    ...
    var DINING_FCFS_REQUESTEDDATE : String?
    ...
    func mapping(map: Map)
    {
        ...
        DINING_FCFS_DININGINFOTHREE <- map["DINING_FCFS_DININGINFOTHREE"]
        DINING_FCFS_REQUESTEDDATE <- map["DINING_FCFS_REQUESTEDDATE"]
        DINING_FCFS_MODIFY_TITLE <- map["DINING_FCFS_MODIFY_TITLE"]
    }
